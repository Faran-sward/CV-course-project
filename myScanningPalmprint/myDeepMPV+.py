...
if __name__ == '__main__':
    # time2 = time.time()
    # Load a model
    modelPath = 'ScanningPalmprintbest.pt'
    ...
    if len(dfg1)<2 or len(dfg2)<2:
        ...
        if similarity>=THRESHOLD: print('Palmprint Verification Success.')
        else: print('Palmprint Verification Fail.', similarity)
        # time5 = time.time()
